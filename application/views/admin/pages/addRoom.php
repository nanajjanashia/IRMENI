	 ...
	 <div class="box box-warning">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input id="txt_roomnumber" type="text" class="form-control" placeholder="" value="" style="width:auto;">
                </div>
                ...
                <div class="form-group">
                  <label>Adults</label>
                  <input id="txt_adults" type="text" class="form-control" placeholder="" value="" style="width:auto;">
                </div>	
					
				<div class="form-group">
                  <label>Kids</label>
                  <input id="txt_kids" type="text" class="form-control" placeholder="" value="" style="width:auto;">
                </div>	
				...
				<div class="form-group">
				<label>Choose icons</label><br>
					<?php 
						if( isset($icons) && !empty($icons) )
						{
							foreach( $icons as $k=>$v )
							{
								echo "<label><input type='checkbox' class='ckbicons' id='cbox".$v->id."' chkbxcon='".$v->icon."' value='".$v->icon."'> ".$v->icon."</i></label><br>";
							}
						}
 ...
 <script>
	...
	data = new Object();
 	...
 	$('.ckbicons').change(function(){
	  ...
	  <div class="box-body">
		<div class="col-md-1">
			<button id="btn-addroom" class="btn btn-block btn-success btn-lg" type="button">Add</button>
		</div>
	  </div>
  </div>	  
</section>
	...
	$( document ).ready(function() {
		...
		$("#btn-addroom").click(function(){
			...
			if(  typeof ($('.roombasic img').attr('src')) != 'undefined' )
			{
				...
				data['homeimage'] = basicimguri.split("/").pop();
			}	
