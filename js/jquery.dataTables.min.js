...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Next",sPrevious:"Previous"},sEmptyTable:"მონაცემები არ არის",sInfo:"ჩანს _START_ - დან _END_ - მდე.  _TOTAL_ მონაცემი",sInfoEmpty:"ჩანს 0-დან 0-მდე. სულ : 0 მონაცემი",sInfoFiltered:"(სულ _MAX_ მონაცემი)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"ჩანს _MENU_ მონაცემი",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"ძიება:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"რეზულტატი - 0"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
